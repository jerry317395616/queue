package org.jeecg.modules.dept.entity;
 ...
 */
@Data
@TableName("clinic_area_dept")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="clinic_area_dept对象", description="诊区科室")
public class ClinicAreaDept implements Serializable {
